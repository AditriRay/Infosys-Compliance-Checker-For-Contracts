...
if __name__ == "__main__":
    ...
    try:
        ...
        if uploaded_file is not None:
            with open("temp_uploded.pdf", "wb") as f:
                ...
                if agreement_type in AGREEMENT_JSON_MAP:
                    ...
                    # Send notification for comparison result
                    body = f"Agreement type: {agreement_type}\n\nComparison Result:\n{result}"
                    notification.send_notification("Compliance Check Completed", body)
        ...
        notification.send_notification("Error Occured in Document Comparison", f"Error is {e}")